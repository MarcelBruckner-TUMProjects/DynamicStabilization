...
namespace dynamic_stabilization {
	namespace stabilization {
		...
		DynamicStabilizationBase::DynamicStabilizationBase() : dynamic_stabilization::utils::TimeMeasurable(
		...
		const std::shared_ptr<dynamic_stabilization::stabilization::matching::FeatureMatchingBase> &
