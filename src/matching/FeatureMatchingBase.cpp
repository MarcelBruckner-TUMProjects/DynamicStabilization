	...
	namespace stabilization {
		namespace matching {
			...
			void FeatureMatchingBase::match(
				const std::shared_ptr<dynamic_stabilization::stabilization::detection::FeatureDetectionBase> &frameFeatureDetector,
				const std::shared_ptr<dynamic_stabilization::stabilization::detection::FeatureDetectionBase> &referenceFeatureDetector
			) {
				clear();
			...
			FeatureMatchingBase::FeatureMatchingBase(float goodMatchRatioThreshold)
				: dynamic_stabilization::utils::TimeMeasurable("FeatureMatchingBase", 1), goodMatchRatioThreshold(
